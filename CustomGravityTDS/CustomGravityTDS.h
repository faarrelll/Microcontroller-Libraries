...
#ifndef C_GRAVITY_TDS_H
#define C_GRAVITY_TDS_H
...
public:
    ...
    void begin(bool use_analog);  //is use analogread
    void update(float volt); //set input volt
    ...
    float getTdsValue();
    float getEcValue();
    void setModeCalibrate(bool is_calibrate); //Modified for enable calibrate or not
