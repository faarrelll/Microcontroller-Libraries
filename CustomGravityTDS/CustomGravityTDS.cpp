...
CustomGravityTDS::CustomGravityTDS()
{
  this->pin = NULL;
...
void CustomGravityTDS::setPin(int pin)
{
  this->pin = pin;
}

void CustomGravityTDS::setTemperature(float temp)
{
  this->temperature = temp;
}

void CustomGravityTDS::setAref(float value)
{
  this->aref = value;
}

void CustomGravityTDS::setAdcRange(float range)
{
  this->adcRange = range;
}

void CustomGravityTDS::setKvalueAddress(int address)
{
  this->kValueAddress = address;
}

/* Modified by APX */
void CustomGravityTDS::setModeCalibrate(bool is_calibrate)
{
  this->do_calibrate = is_calibrate;
}

void CustomGravityTDS::begin()
{
  pinMode(this->pin, INPUT);
  // readKValues();
}

void CustomGravityTDS::begin(bool use_analog)
{
  if (use_analog == false)
  {
    // readKValues();
...
float CustomGravityTDS::getKvalue()
{
  return this->kValue;
}

void CustomGravityTDS::update(float volt)
{
  this->voltage = volt;
...
float CustomGravityTDS::getTdsValue()
{
  return tdsValue;
}

float CustomGravityTDS::getEcValue()
{
  return ecValue25;
}

void CustomGravityTDS::setKvalue(float k)
{
  this->kValue = k;
}

void CustomGravityTDS::readKValues()
{
...
boolean CustomGravityTDS::cmdSerialDataAvailable()
{
  if (this->do_calibrate)
  {
...
byte CustomGravityTDS::cmdParse()
{
  byte modeIndex = 0;
...
void CustomGravityTDS::ecCalibration(byte mode)
{
